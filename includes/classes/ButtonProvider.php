...
class ButtonProvider {
    ...
    public static function createUserButton($con, $username) {
        ...
        return "<a href='$link'>
                    <img src='assets/images/profilePictures/1.png' class='profilePicture'>
                </a>";
    }


    public static function createMessageButton($con, $username) {
        $userObj = new User($con, $username);
        $link = "messaging.php?username=$username";

        return "<a href='$link'>
                    <img src='assets/images/icons/message.png' class='message'>
                </a>";
    }
    ...
    public static function createUserProfileNavigationButton($con, $username) {
        if(User::isLoggedIn()) {
            return ButtonProvider::createUserButton($con, $username);
        }
        else {
    ...
    public static function createUserMessage($con, $username) {
        if(User::isLoggedIn()) {
            return ButtonProvider::createMessageButton($con, $username);
        }
